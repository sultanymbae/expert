  ...
  const services = [
    {
      ...
      features: ["УЗИ органов брюшной полости", "УЗИ сердца", "УЗИ малого таза", "Допплерография"]
    },
    {
      icon: Users,
      title: "ГИНЕКОЛОГИЯ",
      description: "Полный спектр услуг по женскому здоровью и репродуктивной медицине",
      features: ["Консультации гинеколога", "УЗИ малого таза", "Кольпоскопия", "Лечение заболеваний"]
    },
    {
      icon: Dna,
      title: "ГЕНЕТИКА",
      description: "Генетическое консультирование и молекулярно-генетические исследования",
      features: ["Консультация генетика", "Генетические анализы", "Пренатальная диагностика", "Наследственные заболевания"]
    },
    {
      icon: Activity,
      title: "КТГ",
      description: "Кардиотокография для мониторинга состояния плода во время беременности",
      features: ["КТГ плода", "Мониторинг сердцебиения", "Оценка двигательной активности", "Стресс-тесты"]
    },
    {
      icon: Heart,
      title: "КАРДИОЛОГ",
      description: "Диагностика и лечение заболеваний сердечно-сосудистой системы",
      features: ["Консультация кардиолога", "ЭКГ", "ЭхоКГ", "Холтер-мониторинг"]
    },
    {
      icon: Ear,
      title: "ЛОР",
      description: "Диагностика и лечение заболеваний уха, горла и носа",
      features: ["Консультация ЛОР-врача", "Эндоскопия ЛОР-органов", "Аудиометрия", "Лечение синуситов"]
    },
    {
      icon: UserX,
      title: "МАММОЛОГ",
      description: "Диагностика и лечение заболеваний молочных желез",
      features: ["Консультация маммолога", "УЗИ молочных желез", "Маммография", "Биопсия молочной железы"]
    },
    {
      icon: Users,
      title: "УРОЛОГ-АНДРОЛОГ",
      description: "Диагностика и лечение урологических заболеваний у мужчин и женщин",
      features: ["Консультация уролога", "УЗИ мочеполовой системы", "Андрологическое обследование", "Лечение простатита"]
    },
    {
      icon: Zap,
      title: "ЭНДОКРИНОЛОГ",
      description: "Диагностика и лечение заболеваний эндокринной системы",
      features: ["Консультация эндокринолога", "УЗИ щитовидной железы", "Гормональные исследования", "Лечение диабета"]
    },
    {
      icon: TestTube,
      title: "ПРОЦЕДУРНЫЙ КАБИНЕТ",
      description: "Лабораторные и клинические исследования для точной диагностики",
      features: ["Биохимический анализ", "Забор крови", "Лабораторная диагностика", "Интерпретация результатов"]
    }
  ];
